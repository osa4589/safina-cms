...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "collaborator" ADD CONSTRAINT "collaborator_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "cms"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "collaborator" ADD CONSTRAINT "collaborator_invited_by_user_id_fk" FOREIGN KEY ("invited_by") REFERENCES "cms"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "github_user_token" ADD CONSTRAINT "github_user_token_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "cms"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "session" ADD CONSTRAINT "session_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "cms"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
